...
import changed_python_repos_17_3 as chpr

class PythonReposTestCase(unittest.TestCase):
    """Tests for changed_python_repos_17_3.py"""

    def setUp(self):
        """Call all the functions here, and test elements separately."""
        self.r = chpr.get_response()
        self.repo_dicts = chpr.get_repo_dicts(self.r)
        self.repo_dict = self.repo_dicts[0]
        self.repo_links, self.stars, self.labels = chpr.get_project_data(
                self.repo_dicts)
